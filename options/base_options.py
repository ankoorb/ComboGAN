...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--normalize', action='store_true', help='if specified, do not normalize the images with mean and std (hardcoded in get_transform function')
